...
const { index, getBlog, getPopularBlogs, getPopularBlogsByCategory, getRecommendedBlogsForUser, searchBlogsByKeywords, createBlog, updateBlog, deleteBlog, sendLikeFlag} = require ("../controllers/Blogs");
...
router.route("/search-by-keywords").get(validate(schemas.searchBlogsByKeywordsValidation), searchBlogsByKeywords);
